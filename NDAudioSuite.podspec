#
#  Be sure to run `pod spec lint NDAudioSuite.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  #s.author             = { "Drew Pitchford" => "drew.pitchford@metova.com", "Nick Sinas" => "nick.sinas@metova.com" }
  ...
  s.source       = { :git => "https://github.com/metova/NDAudioSuite.git", :tag => "1.0" }
  ...
  s.exclude_files = “NDAudioPlayer/VCs"
